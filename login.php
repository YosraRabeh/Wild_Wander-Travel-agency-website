<?php
include_once 'C:/xampp/htdocs/Works/UserManagment/Dashboard/Controller/accomodationC.php';
include_once 'C:/xampp/htdocs/Works/UserManagment/Dashboard/Model/accomodation.php';

session_start(); 

$UserC=new accomodationC();
...
if(isset($_SESSION['idUser'])&& $_SESSION['idUser']!=-1){
    ...
    if(isset($_POST['email'])&& isset($_POST['password'])){
        ...
        if($userexist==false){
            $iserreur=true;
            $erreur="Email does not exist ";                                     /* Email incorrect ::: Passant pour le password  */
          ...
          echo "Password Verify Result: " . (password_verify($_POST['password'], $userexist['password']) ? 'true' : 'false') . "<br>";  
            */
            if(password_verify($_POST['password'],$userexist['password'])==false){
              var_dump($userexist);
                $iserreur=true;
                $erreur="Mot de passe incorrect";                       /* Password Incorrect */
            }else{
                ...
                if($_SESSION['role']=="Client"){                 
                    ...
                    header("Location:/Works/UserManagment/Dashboard/View/back/material-dashboard-master/pages/accomodation/Afficherhibergement.php");
                    exit; 
                }
            }
        }
      ...
      <div class="col-12">
        ...
        <nav class="navbar navbar-expand-lg blur border-radius-xl top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid ps-2 pe-0">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="Dashboard/View/back/material-dashboard-master/pages/dashboard.html">
              Wild wander
            </a>
            ...
            <div class="collapse navbar-collapse" id="navigation">
              <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center me-2 active" aria-current="page" href="Dashboard/View/back/material-dashboard-master/pages/dashboard.html">
                    <i class="fa fa-chart-pie opacity-6 text-dark me-1"></i>
                    Dashboard
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link me-2" href="Dashboard/View/back/material-dashboard-master/pages/profile.html">
                    <i class="fa fa-user opacity-6 text-dark me-1"></i>
                    Profile
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link me-2" href="Dashboard/View/back/material-dashboard-master/pages/sign-up.html">
                    <i class="fas fa-user-circle opacity-6 text-dark me-1"></i>
                    Sign Up
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link me-2" href="Dashboard/View/back/material-dashboard-master/pages/sign-in.html">
