...
$blogC = new blogC();
$tab = $blogC->listblogs();
$search = isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; // Initialize $search
...
if (!empty($search) && !empty($search_type)) {
    if ($search_type === 'title' || $search_type === 'date') { // Validate search_type
        $tab = ($search_type === 'title') ? $blogC->trieSearchTitles($search) : $blogC->trieSearchDates($search);
    } else {
...
// Display your paginated blog posts here
?>
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="flight.html">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        ...
        window.location.href = 'http://localhost/ali&yossra/ali&yossra/UserManagment/front/travelix-master/addblog.php?token=1';
    }
            </script>
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
              ...
              <button type="submit" class="btn btn-primary">Search<span></span><span></span><span></span></button>
            </form>
                  <thead>
                    <tr>
                  ...
                  ?>
                    <tbody>
                      <tr>
                        ...
                        <td class="align-middle"><?= $blog['user'] ?></td>
                        ...
                        <td class="align-middle text-center">
                          ...
                          <!-- Modal -->
                          <div class="modal fade" id="exampleModal<?= $blog['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel<?= $blog['id'] ?>" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel<?= $blog['id'] ?>">Blog Content</h5>
                        ...
                        <td class="align-middle text-center"><?= $date->format('d/m/Y') ?></td>
                        <td>
                          <div  class="btn btn-success"><a href="http://localhost/ali&yossra/ali&yossra/UserManagment/front/travelix-master/updateblog.php?id=<?= $blog['id'] ?>&token=1">Update</a></div>
                          <div class="btn btn-danger"><a href="http://localhost/ali&yossra/ali&yossra/UserManagment/front/travelix-master/deleteblog.php?id=<?= $blog['id'] ?>&token=1">Delete</a></div>
                          <div class="btn btn-info"><a href="http://localhost/ali&yossra/ali&yossra/UserManagment/front/travelix-master/comments.php?blogid=<?= $blog['id'] ?>&token=1">comments</a></div>
                        </td>
                      </tr>
                    </tbody>
                    <?php } ?>
    ...
    <?php if ($page > 1) : ?>
        <a href="?search=<?php echo $search ?>&search_type=<?php echo $search_type ?>&page=<?php echo ($page - 1) ?>" class="home_slider_custom_dot"><div></div>Previous</a>
    <?php endif; ?>

    <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
        <a href="?search=<?php echo $search ?>&search_type=<?php echo $search_type ?>&page=<?php echo $i ?>" class="home_slider_custom_dot <?php echo ($i == $page) ? 'active' : ''; ?>"><div></div><?php echo str_pad($i, 2, '0', STR_PAD_LEFT); ?>.</a>
    <?php endfor; ?>

    <?php if ($page < $totalPages) : ?>
        <a href="?search=<?php echo $search ?>&search_type=<?php echo $search_type ?>&page=<?php echo ($page + 1) ?>" class="home_slider_custom_dot"><div></div>Next</a>
    <?php endif; ?>
</div>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">NetTitans</a>
            ...
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="https://www.creative-tim.com" class="nav-link text-muted" target="_blank">NetTitans</a>
                </li>
                <li class="nav-item">
