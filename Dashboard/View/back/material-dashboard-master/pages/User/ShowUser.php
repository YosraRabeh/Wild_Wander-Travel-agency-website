        ...
        <div class="row gx-4 mb-2">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
              <img src="uploads/<?php echo $user['image']; ?>" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
            </div>
          </div>
            ...
            <div class="col-12 col-xl-4">
              <div class="card card-plain h-100">
                ...
                <div class="card-body p-3">
                  ...
                  <ul class="list-group">
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Full Name:</strong> &nbsp; <?php  echo $user['username']; ?></li>
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Date of Birth:</strong> &nbsp; <?php  echo $user['dob']; ?></li>
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Password:</strong> &nbsp; <?php  echo $user['password']; ?></li>
                    ...
                    <br><br>
                    <a class="btn btn-outline-primary" href="AfficherUtilisateurs.php">Cancel</a>
                  </ul>
                </div>
              </div>
            </div>
