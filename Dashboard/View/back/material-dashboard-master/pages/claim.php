          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Claims table</h6>
              </div>
            </div>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0  "  id="ContactTable" >
                  <thead>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Rependre</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">supprimer</th>
                      <!--<th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Detuire</th>-->
                  </thead>
                ...
                ?>
                    <tr class="trcolor">
                        ...
                        <td>
                           <a  class="talwin2 " href="voir_contact.php?id=<?php echo $contact['id_contact']; ?>" target="_self">view</a>
                        </td>
                          
                       <td >
                          <a class="talwin2 " href="reponse_contact.php?id=<?php echo $contact['id_contact']; ?>" target="_self">Repondre</a>
                         <!-- <a class="but " href="claim.php.php?id=<?php echo $contact['id_contact']; ?>" target="_self">Retourne</a>-->
                        </td>
                        ...
                        <!--<td>
                        <a  class="talwin2" href="?detuire=true&id=<?php echo $contact['id_contact']; ?>" onclick="return confirm('Es-tu sur(e) que tu vas detruire le message ?')">Detuire</a>
                        </td>-->
