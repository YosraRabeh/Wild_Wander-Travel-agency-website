...
$AccList = $accomodationC->Afficheraccomodation();
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <tr>
                      <td><?php echo $accomodation['id_Acc']; ?></td>
                      <td><?php echo $accomodation['Name']; ?></td>
                      <td><?php echo $accomodation['address']; ?></td>
                      <td><?php echo $accomodation['type_acc']; ?></td>
                  ...
                  <td>
                    <a  class="btn btn-danger btn-sm"   href="Supprimerhibergement.php?id_Acc=<?php echo $accomodation['id_Acc']; ?>">Delete</a>
                  </td>
                    </tr>
                  </tbody>
                  <?php
