...
<head>
  ...
  <link rel="stylesheet" href="Dashboard/View/back/material-dashboard-master/pages/accomodation/assets/style.css">
  <!-- Font Awesome Icons -->
...
<body class="">
                ...
                <div class="card-body">
                  <form method="POST" onsubmit = "return validateForm();">
                    ...
                    <div class="input-group input-group-outline mb-3">
                      ...
                      <input type="date" class="form-control" id="dpb" name="dob" style="border: 1px solid #dee2e6;">
                    </div>
  ...
  <script src="Dashboard/View/back/material-dashboard-master/pages/accomodation/assets/javascript.js"></script>
</body>
