...
if (		
  ...
  )
  {
    $filename = $_FILES["image"]["name"];
      ...
      $UserC->ModifierUser($user,$_GET["idUser"]); 
      header("Location:AfficherUtilisateurs.php?mess= Utilisateur modifié avec succés");
    }
}
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <?php
            if(isset($_GET['idUser']))    /// recuperation de l'utilisateur par id
            {
              $user = $UserC->RecupererUser($_GET['idUser']); 
            ?>
                ...
                <div class="card-body">
                  ...
                  <form method="post" class="forms-sample" name="form" id="form" enctype="multipart/form-data" onsubmit="return validateForm();">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="username" name="username" placeholder=" Username" value="<?php echo $user['username']; ?>" style="border: 1px solid #dee2e6;">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="email" id="email" placeholder=" Email" value="<?php echo $user['email']; ?>" style="border: 1px solid #dee2e6;">
                      <div id="emailError" class="error-message"></div>
                    </div>

                    <div class="form-group">
                      <label for="password">Password</label>
                      <input type="password" class="form-control" id="password" name="password" value="<?php echo $user['password']; ?>" placeholder="Password" style="border: 1px solid #dee2e6; width: 1350px;">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" id="dob" name="dob" value="<?php echo $user['dob']; ?>" style="border: 1px solid #dee2e6;">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" class="form-control" name="image" id="image" style="border: 1px solid #dee2e6;">
                      <span><?php echo basename($user['image']); ?></span>
