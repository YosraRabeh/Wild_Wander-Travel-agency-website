...
include_once 'C:\xampp\htdocs\ali&yossra\ali&yossra\UserManagment\Dashboard\Controller\ReservationC.php';
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item" onmouseover="showSubmenu()" onmouseout="hideSubmenu()">
          ...
          <ul id="submenu" class="submenu">
            <li>
              <a href="pack/AjouterPack.php" class="nav-link text-white">Add</a>
            </li>
            <li>
              <a href="pack/afficherPack.php" class="nav-link text-white">Show</a>
            </li>
          </ul>
        </li>
