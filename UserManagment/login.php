      ...
      <div class="col-12">
        ...
        <nav class="navbar navbar-expand-lg blur border-radius-xl top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid ps-2 pe-0">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="Dashboard/View/back/material-dashboard-master/pages/dashboard.php">
              Wild wander
            </a>
            ...
            <div class="collapse navbar-collapse" id="navigation">
              <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center me-2 active" aria-current="page" href="Dashboard/View/back/material-dashboard-master/pages/dashboard.php">
