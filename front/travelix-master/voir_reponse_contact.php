...
$reponse_idR = $reponse_gestion->voir_repon($contact["id_contact"],'mawjoud');
...
<div class="super_container">
	...
	<div class="contact_form_section" >
     ...
     <form >
     <form id="form">
            <h3 class="text" style="color: black;"><u>Votre reclamtion a ete envoyee le <?php echo $contact['date_envoie']; ?>  : </u> </h3>
            <label for="textarea" style="color: black;">M<?php echo $contact['description']; ?></label>

            <div id="divgrid">
               <a href="#" class="but" onmouseover="toggleImage('imageRanime/message.png')" onmouseout="toggleImage('imageRanime/message.png')" onclick="toggleResponses()">
                     <img id="responseImage" width="25" src="imageRanime/message.png">
              </a>
         </div>
            ...
            <div id="responsesContainer" style="display: none;" class="reponsecontainer">
                ...
                foreach ($reponse_idR as $reponse) {
                    ...
                    <div>
                        <hr>
                        <label class="text2" style="color: black;">Repense  <?= $i; ?> le  <?= $reponse['date_envoie_r']; ?>  : </label>
                        <label style="color: black;"> <?php echo $reponse['Reponse']; ?> </label>
                        <hr>
                    </div>
                    <?php
                    $i++;
