...
<div class="super_container">
			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						<div class="phone">+216 90 04 04 16</div>
						<div class="social">
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="home_title">Packs Liste</div>
		</div>
	</div>
				...
				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						...
						<div class="intro_item_background">
							...
							?>
							<img src="../../Dashboard/View/back/material-dashboard-master/pages/pack/uploads/<?php echo $img; ?>" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; filter: blur(2px);" alt="Background Image">
						</div>
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center" style="margin-bottom: -20px;">

							<form method="GET" action="modifierReservationF.php">
						  ...
						  <a class="btn btn-danger" href="SupprimerReservationF.php?idReservation=<?php echo $reservation['idReservation']; ?>">Supprimer</a>
							<div class="intro_center text-center">
								...
								<div class="intro_price"><b>Paiement : <?php echo $reservation['paiement']; ?></b></div>
								<br>
								<span>Date Creation : <?php echo $reservation['dateCreation']; ?></span>
							</div>
						</div>
					</div>
				</div>
