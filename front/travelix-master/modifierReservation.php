...
if (isset($_POST["nombrePlaces"]) && isset($_POST["source"]) && isset($_POST["paiement"])) {

    echo "<script>console.log('Form data submitted');</script>";

    if (!empty($_POST["nombrePlaces"]) && !empty($_POST["source"]) && !empty($_POST["paiement"])) {

		$Reservation = new Reservation(
            $_POST['nombrePlaces'], 
            $_POST['source'],
            $_POST['paiement'],
            $_POST['idOffre'] // Assuming you also need to retrieve 'idOffre'
        );
...
// Handling case when 'idReservation' is not set
if (!isset($_GET["Reserver"]) || !isset($_GET["idOffre"])) {
...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="home_title">Your Reservation</div>
		</div>
	</div>
					...
					<div class="row fill_height no-margin">
						<div class="col fill_height no-padding">
							...
							<div class="search_panel active">
								...
								?>
								<form method="post"  id="form" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start" enctype="multipart/form-data">
									<div class="search_item">
										<div>Number of Seats: </div>
										<input type="number" id="nombrePlaces" name="nombrePlaces" class="destination search_input" value="<?php echo $Reservation['nombrePlaces'];  ?>" >
									</div>
									<div class="search_item">
										<input type="hidden" name="idOffre" id="idOffre" class="check_in search_input"  value="<?php echo $Reservation['idOffre'];  ?>">
									</div>

									<div class="search_item">
										<div>Source : </div>
										<select name="source" id="source" class="dropdown_item_select search_input">
									...
									<div class="search_item">
										...
										<select name="paiement" id="paiement" class="dropdown_item_select search_input">
								...
								<button class="btn btn-warning" type="submit">Confirm Reservation</button>
								</form>
								<?php
								}
								?>
					...
					<div class="footer_nav_container d-flex flex-row align-items-center justify-content-lg-end">
						<div class="footer_nav">
							<ul class="footer_nav_list">
								...
								<li class="footer_nav_item"><a href="pack.php">Packs</a></li>
