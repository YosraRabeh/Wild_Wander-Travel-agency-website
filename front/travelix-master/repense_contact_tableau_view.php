<?php
include "C:/xampp/htdocs/ali&yossra/ali&yossra/UserManagment/Dashboard/Controller/gestion_contact.php";
...
$list = $contact_gestion->show_Notification('traiter',$_SESSION['idUser']);



// inchoufou kan delete mawjoud wala le 
if (isset($_GET["delete"]) && isset($_GET["id"])) { 
   $contact_table =  $contact_gestion->showContact($_GET["id"]) ; 
   $date=date($contact_table['date_envoie']); 
   $contact = new contact( $contact_table['id_contact'], $contact_table['idUser'], new DateTime($date), $contact_table['sujet_contact'], $contact_table['description'] );
       
   $contact =$contact->setEtat('***'); 
  
   $contact_gestion->updateContact($contact, $_GET["id"]);
...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="home_title">Messages</div>
		</div>
	</div>
     ...
     <form >
                 ...
                 ?>
                        <table>
                            <tbody>       
                                ...
                                ?>
                                    <tr class="notification_tafsi5">
                                        <td  style="color: blue; font-weight: bold; padding:50px;"> > MESSAGE : <?= $i; ?> </td>

                                        <td  style="color: black;padding:50px;"> <u>Sujet :</u> <?= $contact['sujet_contact']; ?> </td>
                                       <<td  style="color: black;padding:50px;"> <u> date d envoie : </u> <?= $contact['date_envoie']; ?></td>

                                        <td>
                                            <a style="padding:50px;" href="voir_reponse_contact.php?id=<?php echo $contact['id_contact']; ?>" target="_self">view</a>
                                        </td>


                                        <td class="notification_tafsi5">
                                            <a href="?delete=true&id=<?php echo $contact['id_contact']; ?>" onclick="return confirm('Are you sure you want to delete this entry?')">Delete</a>
                                        </td>
                            ...
                            echo '<center><img src="imageRanime/nomess.png"></center> ';
                        }
                        ?>
