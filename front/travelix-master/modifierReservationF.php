...
// Check if 'idReservation' is set in GET parameters
...
if (isset($_POST["nombrePlaces"]) && isset($_POST["source"]) && isset($_POST["paiement"])) {
    ...
    if (!empty($_POST["nombrePlaces"]) && !empty($_POST["source"]) && !empty($_POST["paiement"])) {
        // Create Reservation object and modify reservation
						...
						<div class="col fill_height no-padding">
							...
							<form method="POST" id="formR" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
								...
								<div class="search_item">
									...
									<select class="form-select" id="source" name="source" aria-label="Select source">
								...
								<div class="search_item">
									<label for="paiement">Payment Method:</label>
									<select class="form-select" id="paiement" name="paiement" aria-label="Select payment method">
