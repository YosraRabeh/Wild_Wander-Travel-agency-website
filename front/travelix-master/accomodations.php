<?php
include '../../Dashboard/Controller/accomodationC.php';
						...
						<div class="col fill_height no-padding">
							...
							<div class="search_tabs_container">
								<div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
									<div class="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/suitcase.png" alt=""><span>hotel</span></div>
									<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/suitcase.png" alt="">guest house</div>
									<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/suitcase.png" alt="">rental</div>
								</div>		
							</div>
							...
							<div class="search_panel">
								<form action="#" id="search_form_3" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
									...
									<div class="search_item">
										<div>type</div>
										<select name="type" id="adults_3" class="dropdown_item_select search_input">
											<option>villa</option>
									...
									<div class="search_item">
										<div>size</div>
										<select name="size" id="children_3" class="dropdown_item_select search_input">
											<option>s+0</option>
											<option>s+1</option>
											<option>s+2</option>
											<option>s+3</option>
