						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="offers_content">
									...
									<div class="offers_link"><a href="flights.html">read more</a></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="footer_nav_container d-flex flex-row align-items-center justify-content-lg-end">
						<div class="footer_nav">
							<ul class="footer_nav_list">
								...
								<li class="footer_nav_item"><a href="flights.html">flights</a></li>
								<li class="footer_nav_item"><a href="blog.html">accomodations</a></li>
								<li class="footer_nav_item"><a href="blog.html">packs</a></li>
