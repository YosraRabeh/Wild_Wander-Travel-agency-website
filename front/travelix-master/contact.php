...
if (isset($_SESSION['idUser'])) 
{
    ...
    if ($user) {
        ...
        echo "No user found !!";
        exit; // Arrête l'exécution si aucun utilisateur n'est trouvé
    }
	$client = $contact_gestion->showClient($idUser);
    if (!$client) {
        echo "No client data found!";
        exit; // Arrête l'exécution si aucune donnée client n'est trouvée
    }
} else {
    echo "idUser not setted";
    exit; // Arrête l'exécution si idUser n'est pas défini
}
			...
			<div class="row">
				<div class="col">
					...
					<div class="contact_form_container">
						...
						<form id="contact_form" class="contact_form text-center" action='/ali&yossra/ali&yossra/UserManagment/Dashboard/Controller/traitement_contact.php' method="POST">
