							...
							<div class="col-12 col-xl-4">
							  <div class="card card-plain h-100">
								...
								<div class="card-body p-3">
								  <p class="text-sm">
									Hi, I’m <?php  echo $username; ?>, an avid traveler and a nature enthusiast. I find immense joy in exploring the wonders of the world. Each journey is an opportunity for me to discover new horizons, broaden my perspectives, and connect with different cultures.
								  </p>
