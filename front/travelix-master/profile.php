...
if (isset($_GET['id'])) {
    ...
    // Fetch user data using $userId (assuming you have a function to retrieve user data)
    $user = $userC->RecupererUser($userId); // Replace getUserDataById with your actual function
